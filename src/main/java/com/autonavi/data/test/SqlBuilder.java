...
public class SqlBuilder {
	...
	public static String buildInsertSql(String tableName, Map<String, Object> dataMap) {
	...
	/**
	 * Build update sql with sql clauses
	 * 
	 * @param tableName
	 * @param dataMap
	 * @param clauseList
	 ...
	 * @return
	 */
	public static String buildUpdateSql(String tableName, Map<String, Object> dataMap,
			List<String> clauseList, Map<String, Object> clauseWordMap) {
		...
		for (String clauseKey : clauseKeySet) {
			...
			} else if (clauseVal instanceof BigDecimal || clauseVal instanceof Integer || clauseVal instanceof Double
					|| clauseVal instanceof Float) {
				sqlBuilder.append(String.format("%s=%s AND ", clauseKey, clauseVal));
			}
		}
	 ...
	 * @return
	 */
	public static String buildUpdateSql(String tableName, Map<String, Object> dataMap, String clauseColumn,
			String clauseWord) {
		StringBuilder sqlBuilder = new StringBuilder("UPDATE " + tableName + " SET ");
			...
			if (value instanceof String) {
				...
				if (i < keyArray.length - 1) {
					sqlBuilder.append(key + "="
							+ String.format("to_timestamp('%s', 'yyyy-mm-dd hh24:mi:ss:ff')", sValue) + ",");
				} else {
					sqlBuilder.append(key + "="
							+ String.format("to_timestamp('%s', 'yyyy-mm-dd hh24:mi:ss:ff') ", sValue));
				}
	 ...
	 * @return
	 */
	public static String buildSelectSql(String tableName, List<String> clauseList,
			Map<String, Object> clauseWordMap) {
